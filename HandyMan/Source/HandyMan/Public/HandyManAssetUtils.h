...
namespace GG
{
	namespace HandyMan
	{
		 ...
		 */
		HANDYMAN_API FString GetNewAssetPathName(const FString& BaseName, const UWorld* TargetWorld, FString SuggestedFolder);
		 ...
		 */
		HANDYMAN_API FString GetWorldRelativeAssetRootPath(const UWorld* World);

		/**
		 * Determines the global asset root path.
		 * @return Global asset root path.
		 */
		HANDYMAN_API FString GetGlobalAssetRootPath();
		 ...
		 */
		HANDYMAN_API void OnNewAssetCreated(UObject* Asset);
		 ...
		 */
		HANDYMAN_API bool AutoSaveAsset(UObject* Asset);
