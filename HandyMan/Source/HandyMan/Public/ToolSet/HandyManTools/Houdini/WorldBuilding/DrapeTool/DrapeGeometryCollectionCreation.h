...
UENUM()
enum class EDrawPolygonDrawMode_Drape : uint8
{
...
UENUM()
enum class EDrawPolygonExtrudeMode_Drape : uint8
{
...
UCLASS()
class HANDYMAN_API UDrapeToolStandardProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UDrapeToolStandardProperties();
	...
	EDrawPolygonDrawMode_Drape PolygonDrawMode = EDrawPolygonDrawMode_Drape::Freehand;
...
UCLASS()
class HANDYMAN_API UDrapeToolSnapProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class HANDYMAN_API UDrapeGeometryCollectionCreation : public UHandyManInteractiveTool, public IClickSequenceBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UDrapeToolStandardProperties> PolygonProperties;

	UPROPERTY()
	TObjectPtr<UDrapeToolSnapProperties> SnapProperties;
	...
	bool GeneratePolygonMesh(const TArray<FVector3d>& Polygon, const TArray<TArray<FVector3d>>& PolygonHoles, UE::Geometry::FDynamicMesh3* ResultMeshOut, UE::Geometry::FFrame3d& WorldFrameOut, bool bIncludePreviewVtx, double ExtrudeDistance, bool bExtrudeSymmetric);
	...
	friend class FDrawDrapeGeoStateChange;
...
class HANDYMAN_API FDrawDrapeGeoStateChange : public FToolCommandChange
{
public:
	...
	FDrawDrapeGeoStateChange(int32 CurveTimestampIn,
