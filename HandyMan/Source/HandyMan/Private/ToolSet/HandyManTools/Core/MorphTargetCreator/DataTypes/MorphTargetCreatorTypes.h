...
#include "MorphTargetCreatorTypes.generated.h"
...
UENUM()
enum class EMorphTargetSculptFalloffType : uint8
{
	Smooth = 0,
	Linear = 1,
	Inverse = 2,
...
/** Mesh Sculpting Brush Types */
UENUM()
enum class EMorphTargetBrushType : uint8
{
...
UENUM()
enum class EMorphTargetBrushFilterType : uint8
{
