...
#include "HandyManPinchBrushOps.generated.h"


UCLASS()
class HANDYMAN_API UHandyManPinchBrushOpProps : public UHandyManMeshSculptBrushOpProps
{
	GENERATED_BODY()
public:
...
class FHandyManPinchBrushOp : public FHandyManMeshSculptBrushOp
{
...
public:
	...
	virtual void ApplyStamp(const FDynamicMesh3* Mesh, const FHandyManSculptBrushStamp& Stamp, const TArray<int32>& Vertices, TArray<FVector3d>& NewPositionsOut) override
	{
		...
		bool bLimitDrag = GetPropertySetAs<UHandyManPinchBrushOpProps>()->bPerpDamping;
