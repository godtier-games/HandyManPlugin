...
#include "HandyManBrushStampIndicator.generated.h"

class UPrimitiveComponent;
class UPreviewMesh;

UCLASS(MinimalAPI)
class UHandyManBrushStampIndicatorBuilder : public UInteractiveGizmoBuilder
{
	GENERATED_BODY()
public:
...
class UHandyManBrushStampIndicator : public UInteractiveGizmo
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	virtual void Update(float Radius, const FVector& Position, const FVector& Normal, float Falloff, float Strength);
