...
#include "HandyManSculptUtil.h"
#include "Async/ParallelFor.h"
#include "Async/Async.h"

using namespace UE::Geometry;

void HandyMan::SculptUtil::RecalculateNormals_Overlay(
	FDynamicMesh3* Mesh, 
...
void HandyMan::SculptUtil::RecalculateNormals_PerVertex(
	FDynamicMesh3* Mesh, 
	const TSet<int32>& ModifiedTris, 
	TSet<int32>& VertexSetBuffer, 
	TArray<int32>& NormalsBuffer)
...
void HandyMan::SculptUtil::RecalculateROINormals(
	FDynamicMesh3* Mesh, 
...
void HandyMan::SculptUtil::PrecalculateNormalsROI(
...
void HandyMan::SculptUtil::RecalculateROINormals(FDynamicMesh3* Mesh, const TArray<int32>& Indices, bool bIsOverlayElements)
{
...
void HandyMan::SculptUtil::PrecalculateNormalsROI(const FDynamicMesh3* Mesh, const TArray<int32>& TriangleROI,
...
void HandyMan::SculptUtil::RecalculateROINormals(FDynamicMesh3* Mesh, TArray<std::atomic<bool>>& ROIFlags, bool bIsOverlayElements)
{
	if (bIsOverlayElements)
	{
		FDynamicMeshNormalOverlay* Normals = Mesh->HasAttributes() ? Mesh->Attributes()->PrimaryNormals() : nullptr;
