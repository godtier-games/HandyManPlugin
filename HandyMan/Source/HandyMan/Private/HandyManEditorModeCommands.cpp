...
#define LOCTEXT_NAMESPACE "HandyManEditorModeCommands"

FHandyManEditorModeCommands::FHandyManEditorModeCommands() :
	TCommands<FHandyManEditorModeCommands>(
		"HandyManEditorModeToolCommands", // Context name for fast lookup
		NSLOCTEXT("Contexts", "HandyManEditorModeToolCommands", "HandyMan Mode - Tools"), // Localized context name for displaying
		NAME_None, // Parent
		FHandyManEditorModeStyle::Get()->GetStyleSetName() // Icon Style Set
		)
{
}
...
TSharedPtr<FUICommandInfo> FHandyManEditorModeCommands::FindToolByName(FString Name, bool& bFound) const
{
	bFound = false;
...
void FHandyManEditorModeCommands::RegisterCommands()
{
